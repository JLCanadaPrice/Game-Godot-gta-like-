...
func _drive_physics(delta: float) -> void:
	...
	# Montée de trottoir : gérée nativement par move_and_slide grâce aux rampes
	# de collision en pente ajoutées le long des bordures (voir CurbRamp.gd).
	# Plus aucun raycast/nudge scripté ici.
