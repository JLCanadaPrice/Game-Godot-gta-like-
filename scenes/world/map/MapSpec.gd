...
# Seul écart volontaire avec la référence : la rivière passe ~150 m plus à l'ouest le long du centre-ville pour loger
...
const NODES := {
	...
	"e_vxo_s": {"pos": Vector2(-455, 1120), "kind": "edge"},
	...
	"x_no": {"pos": Vector2(-700, -700), "kind": "interchange", "shape": "cloverleaf"},
	"x_ne": {"pos": Vector2(1050, -596), "kind": "interchange", "shape": "cloverleaf"},
	"x_so": {"pos": Vector2(-700, 470), "kind": "interchange", "shape": "merge"},
	"x_st": {"pos": Vector2(-484, 808), "kind": "interchange", "shape": "trumpet"},
	"x_se": {"pos": Vector2(686, 496), "kind": "interchange", "shape": "merge"},
	...
	"d_s7": {"pos": Vector2(-249, 793), "kind": "diamond"},
	...
	"j_sw": {"pos": Vector2(-245, 930), "kind": "junction", "lit": false},
	...
	"n_motel": {"pos": Vector2(-470, 600), "kind": "end"},
}
...
const ROADS := [
	...
	{"id": "vxo_s1", "class": "highway", "axis": "vxo", "from": "x_no", "to": "d_o172", "via": [Vector2(-760, -650), Vector2(-880, -585), Vector2(-985, -500), Vector2(-1028, -380)]},
	{"id": "vxo_s2", "class": "highway", "axis": "vxo", "from": "d_o172", "to": "d_o116", "via": []},
	{"id": "vxo_s3", "class": "highway", "axis": "vxo", "from": "d_o116", "to": "x_so", "via": [Vector2(-1005, 240), Vector2(-880, 350), Vector2(-760, 430)]},
	{"id": "vxo_s4", "class": "highway", "axis": "vxo", "from": "x_so", "to": "x_st", "via": [Vector2(-600, 580), Vector2(-520, 700)]},
	{"id": "vxo_s5", "class": "highway", "axis": "vxo", "from": "x_st", "to": "e_vxo_s", "via": [Vector2(-465, 960)]},
	{"id": "as_o1", "class": "highway", "axis": "as", "from": "e_as_o", "to": "d_so13", "via": [Vector2(-2174, 574), Vector2(-1749, 553)]},
	{"id": "as_o2", "class": "highway", "axis": "as", "from": "d_so13", "to": "x_so", "via": [Vector2(-1157, 490), Vector2(-1000, 455), Vector2(-860, 450), Vector2(-760, 465)]},
	{"id": "as_e1", "class": "highway", "axis": "as", "from": "x_st", "to": "d_s7", "via": []},
	{"id": "as_e2", "class": "highway", "axis": "as", "from": "d_s7", "to": "x_se", "via": [Vector2(-94, 782), Vector2(460, 691)]},
	...
	{"id": "a3", "class": "arterial", "urban": false, "from": "g_n892", "to": "n_a3", "via": [Vector2(-892, -650), Vector2(-900, -850), Vector2(-916, -1159)]},
	{"id": "a4", "class": "arterial", "urban": true, "from": "g_n532", "to": "j_green", "via": [Vector2(-532, -620), Vector2(-500, -760), Vector2(-457, -800)]},
	...
	{"id": "a7_s", "class": "arterial", "urban": true, "from": "j_motel", "to": "d_s7", "via": [Vector2(-280, 690)]},
	...
	{"id": "a10", "class": "arterial", "urban": false, "from": "j_sw", "to": "e_a10", "via": [Vector2(-400, 925), Vector2(-560, 905), Vector2(-672, 883), Vector2(-874, 937), Vector2(-999, 1003)]},
]
const AXES := {
...
const RAIL := [
	...
	Vector2(-449, 262), Vector2(-600, 430), Vector2(-700, 620), Vector2(-719, 760), Vector2(-850, 830),
	Vector2(-1000, 870), Vector2(-1416, 900), Vector2(-2174, 930), Vector2(-2300, 935),
]
...
const POIS := [
	...
	{"id": "motel", "name": "Starlite Motor Inn", "kind": "motel", "pos": Vector2(-500, 600), "size": Vector2(70, 40), "yaw": 90.0, "access": "n_motel"},
