...
const GATE_SPOTS := [
	...
	{"name": "rue locale de Midtown Nord", "pos": Vector2(-453.3, -758.5), "yaw": 89.4, "min_stage": 4.0},
	{"name": "rue locale de Willow Lake", "pos": Vector2(-1256.0, -47.5), "yaw": -180.0, "min_stage": 4.0},
	{"name": "rue locale de Westbank", "pos": Vector2(-1244.2, 281.4), "yaw": -174.5, "min_stage": 4.0},
	{"name": "rue locale d'Eastside", "pos": Vector2(215.4, -435.4), "yaw": -105.7, "min_stage": 4.0},
	{"name": "rue locale d'Eastgate", "pos": Vector2(1089.9, 490.8), "yaw": 176.7, "min_stage": 4.0},
