...
- **LE BRAQUAGE ÉTAIT UN CARROSSAGE sur les 54 modèles `city_*`** (2026-09-21 au soir). Le joueur voyait, en
  ...
  **La circulation ne braquait pas du tout** : elle passait un braquage NUL à `_update_visuals`. Ses roues avant
  ...
  après, dans `D:/p-recree/ground_shots/braquage_2026-09-21/` (hors dépôt) : de face à 1,2 m, le pare-chocs de la
...
- La **« cage vitrée »** est une tour (x ±5,52, z 7,48..11,87) que chaque plateau traverse : une pièce de 11 x 2,3 m
  ...
  avec une rampe d'accès de 0,36 m sur 1,35 m.
...
**Étape 6 — rayon de braquage par modèle, réduit à vitesse** (`Car.gd`, 2026-09-22). Modèle BICYCLETTE sur
...
- **Pièges payés en mesurant** (sondes gardées hors dépôt : `D:/p-recree/sondes/2026-09-23_collision_exacte/`, avec un
  LISEZMOI) :
...
teste en jeu. Un commit par point, tests concernés seulement. Il pousse lui-même.
...
**C. Sondes** : hors du dépôt dans `D:/p-recree/sondes/2026-09-23_collision_exacte/`, avec leurs logs. Leurs `.tscn`
