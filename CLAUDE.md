...
- **POMPIERS** : **tous** les feux, rouges en rouge et blancs en blanc, toutes les rampes, tous les
  segments, **synchronisés** (`GYRO_SYNCHRO`).
...
jamais. Il ne remplace pas la simulation longue, qui se fait avec la sonde de toute la carte (30 min de jeu,
gel coupé).
